...
<body onload="load();">
  ...
  <center>
  <br /> <br /> <br /> <b>Delete all informations about your account?</b> <br />
  <br />
  <div>
 ...
 <td></td>
    ...
    delete_ = function(id){     
         $.ajax({
            ...
            data:{user_id:id},
            success: function(response){
            	window.location = '/LogN/services/login';
            }              
        });
}
        ...
        $.ajax({
            ...
            success: function(response){
                    ...
                    for(i=0; i<response.data.length; i++){                  
                        $("#table").append("<tr class='tr'> <td> <button href='#' onclick='delete_("+response.data[i].user_id+");'> Confirm </button>  </td>  </tr>");
